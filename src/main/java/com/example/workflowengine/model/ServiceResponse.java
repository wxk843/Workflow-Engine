...
import com.example.workflowengine.enmus.ResultMsg;
import com.example.workflowengine.utils.TimeUtil;
...
public class ServiceResponse<T> implements Serializable {
     ...
     */
    @Getter
    @ApiModelProperty(value = "响应时间(格式如2017-04-27 13:42:54)")
     ...
     * 征信订单构建成功及失败的code
     */
    public static final int CREDIT_SUCCESS_KEY = 1000;
    public static final int CREDIT_FAIL_KEY = 1001;
}
